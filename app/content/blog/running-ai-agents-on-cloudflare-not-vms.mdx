...
description: "Construct is an AI employee with a real Linux computer per user. Don't get excited - we are not paying for the idle ones. How we run that on Cloudflare Durable Objects, Sandboxes, and R2."
