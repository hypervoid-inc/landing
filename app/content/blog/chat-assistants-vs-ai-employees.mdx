...
1. **Persistence** — Construct keeps workspace files, procedures, and inspectable memory beyond the current thread.
2. **Integrations** — a live catalog of supported connected apps the agent can act on directly, not via copy-paste.
3. **Inspectable work** — bounded Activity summaries, chat tool records, sent messages, connected-app updates, and workspace artifacts instead of chat text alone.
